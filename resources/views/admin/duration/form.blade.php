...
<div class="header-sticky">{{ __('buttons.' . $action) . ' ' . __('fields.duration') }}</div>

{!! Form::model($duration, array_merge($form_data, array('role' => 'form', 'class' => 'form-horizontal'))) !!}
...
{!! Form::submit(__('buttons.' . $action) . ' ' . ucfirst(__('fields.duration')), array('class'=>'btn
btn-primary') ) !!}
