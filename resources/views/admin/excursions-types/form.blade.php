...
<div class="header-sticky">{{ __('buttons.' . $action) . ' ' . trans_choice('fields.excursionType', 1) }}</div>
...
{!! Form::submit(__('buttons.' . $action) . ' ' . ucfirst(trans_choice('fields.excursionType', 1)), array('class'=>'btn
btn-primary') ) !!}
